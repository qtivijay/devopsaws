module "mysql_sg" {
    ...
    source = "git::https://github.com/qtivijay/terraform-aws-security-group.git?ref=main"
...
# backend allowing connection on 8080 from the instances attached to Backend SG
